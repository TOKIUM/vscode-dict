...
export function activate(context: vscode.ExtensionContext) {
	...
	const reloadCommand = ReloadCommand.from(dictionaryStorage, treeView.treeDataProvider, summaryTextDocumentContent.provider, detailTextDocumentContent.provider);
	...
	vscode.commands.executeCommand(ReloadCommand.id);
}
